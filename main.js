    ...
    const vm = new Vue({
        ...
        created: function ()  {
            this.loadData().then(response => {
                ...
                this.property.default_logo_url = "//codecloud.cdn.speedyrails.net/sites/5b88438d6e6f641e8d3c0000/image/png/1529701995203/default_logo_600.png";               
        ...
        methods: {
            loadData: async function() {
                try{
                    await this.$store.dispatch('initializeApi', { site: "lindsaysquare", version: "v4" });
