                ...
                <div class="main_container mobile_padding margin_30">
                    <div class="details_row">
                        <div class="details_col_3 hidden_phone">
                             <img class="img_max" src="//codecloud.cdn.speedyrails.net/sites/5b88438d6e6f641e8d3c0000/image/jpeg/1534358207000/sidebanner6.jpg" alt="" />    
                        </div>
        ...
        return Vue.component("leasing-permanent-component", {
            ...
            methods: {
                loadData: async function () {
                    ...
                    try {
                        let results = await Promise.all([this.$store.dispatch('LOAD_PAGE_DATA', { url: this.property.mm_host + "/pages/lindsaysquare-permanent-leasing.json"})]);
                        return results;
                    } catch (e) {
                ...
                validateBeforeSubmitPerm() {
                    this.$validator.validate().then((result) => {
                        ...
                        if (result) {
                            ...
                            perm_formdata.send_to = "huntleyj@davpart.com, waggi@davpart.com ,lindsaysquare@cogeco.net";
                            perm_formdata.subject = "Lindsay Square Permanent Leasing Form"; 
                            perm_formdata.body = {};
