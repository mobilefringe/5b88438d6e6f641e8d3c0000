                ...
                <div class="main_container mobile_padding margin_30">
                    <div class="details_row">
                        ...
                        <div class="details_col_9" v-if="currentEvent">
                            ...
                            <img v-if="_.includes(this.currentEvent._.includes(this.currentEvent.event_image_url_abs, 'missing'), 'missing')" v-lazy="currentEvent.image_url" :alt="'Event: ' + currentEvent.name" class="margin_20 img_max"/>
